...
public final class WalletGrpc {
  ...
  public static io.grpc.MethodDescriptor<org.tron.api.GrpcAPI.EmptyMessage,
    ...
    if ((getGetDynamicPropertiesMethod = WalletGrpc.getGetDynamicPropertiesMethod) == null) {
      synchronized (WalletGrpc.class) {
        if ((getGetDynamicPropertiesMethod = WalletGrpc.getGetDynamicPropertiesMethod) == null) {
          WalletGrpc.getGetDynamicPropertiesMethod = getGetDynamicPropertiesMethod = 
              io.grpc.MethodDescriptor.<org.tron.api.GrpcAPI.EmptyMessage, org.tron.protos.Protocol.DynamicProperties>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "protocol.Wallet", "GetDynamicProperties"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.tron.api.GrpcAPI.EmptyMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.tron.protos.Protocol.DynamicProperties.getDefaultInstance()))
                  .setSchemaDescriptor(new WalletMethodDescriptorSupplier("GetDynamicProperties"))
                  .build();
          }
        }
     }
  ...
  private static final int METHODID_GET_DYNAMIC_PROPERTIES = 20;
